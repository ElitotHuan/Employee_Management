...
public interface DepManagerRepository  extends JpaRepository<DepManager, DepManagerID> {
    ...
    @Query(value = "select new com.web_service.employee_management.features.department_manager.DepManagerDTO(dm.id.department.departmentName , dm.id.employee.fullName) " +
            "from DepManager dm ")
