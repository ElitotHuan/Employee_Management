...
public class EmployeeService {
    ...
    public Object updateEmployee(Long id, Employee updateInfo) {
        ...
        if (!Objects.equals(original.getDepartment().getId(), updateInfo.getDepartment().getId())) {
            original = new Employee(updateInfo.getFullName(), updateInfo.getBirthDay(), updateInfo.getPhoneNumber(),
                    original.getHiredDate());
        ...
        original.setFullName(updateInfo.getFullName());
        original.setBirthDay(updateInfo.getBirthDay());
        original.setPhoneNumber(updateInfo.getPhoneNumber());
